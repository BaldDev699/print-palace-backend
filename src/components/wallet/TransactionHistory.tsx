                ...
                {withdrawals.map((withdrawal) => (
                  <div key={withdrawal.id} className="p-4 border rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm text-muted-foreground">
                      <div>
                        <p>Network Fee: {Number(withdrawal.network_fee || 0).toLocaleString()} RC</p>
                        <p>Final Amount: {Number(withdrawal.final_amount || 0).toLocaleString()} RC</p>
                      </div>
                      <div>
                        <p>Address: {withdrawal.wallet_address.slice(0, 6)}...{withdrawal.wallet_address.slice(-4)}</p>
                        <p>Date: {formatDistanceToNow(new Date(withdrawal.created_at), { addSuffix: true })}</p>
                      </div>
                    </div>

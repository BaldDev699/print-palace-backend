...
import { 
  Circle, Square, Triangle, Diamond, Hexagon, Star, Heart, Crown, Shield, 
  Badge, Award, Target, Leaf, Sun, Moon, TreePine, Mountain, ArrowUp, 
  ArrowDown, ArrowLeft, ArrowRight, Building, Briefcase, Cog, BarChart3,
  Phone, Mail, MessageCircle, Wifi, Car, Plane, Ship, Bike, Trophy,
  Zap, Flame, Sparkles, Music, Camera, Gift, Home, Coffee, Palette
} from 'lucide-react';

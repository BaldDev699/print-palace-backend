        ...
        <div className="mt-6 p-4 bg-muted/50 rounded-lg">
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <p>DTG is best for detailed, colorful designs. No Cut works great for simple graphics and text. Embroidery provides the most premium feel for text and simple logos.</p>
            </div>
          </div>
        </div>
